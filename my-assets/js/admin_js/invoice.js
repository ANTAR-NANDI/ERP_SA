...
function calculateSum() {
    ...
    var t = 0,
        ...
        ser_charge = ($("#service_charge").val() ? $("#service_charge").val() : 0),
    ...
    var test = +tx + +s_cost + +ser_charge + +x + -ttl_discount + + ad - commission - cc;
    var test2 = +tx + +s_cost + +ser_charge + +x + -ttl_discount + + ad;
...
function calc_paid() {
    ...
    var paid_amount = (parseFloat($("#paid_ammount_fixed").val()) ? parseFloat($("#paid_ammount_fixed").val()) : 0);

    $(".p_amount").each(function () {
        isNaN(this.value) || 0 == this.value.length || (pt += parseFloat(this.value))
    });
    // console.log(pt + " Paid Amount" + paid_amount)
