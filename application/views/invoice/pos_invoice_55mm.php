        ...
        <div class="row" style="border: 0 !important; margin: 0 !important;">
            <div class="col-sm-12" style="border: 0 !important; margin: 0 !important;">
                        ...
                        <div class="panel-body" style="border: 0 !important; margin-left: -3mm !important;">
                            ...
                            <?php if ($setting_company_logo == "1") { ?>
                                <div style="width: 100%;" class="text-center">
                                    <img src="<?= $outlet_logo ? $outlet_logo : $inv_logo ?>" style="width: 20mm; height: auto;">
                                </div>
                            <?php } ?>
                                    ...
                                    <div style="margin-top: 0.3cm !important;">
                                        <div>
                                            ...
                                            <nobr style="font-size: 11px;">
                                                <nobr><?php echo invoice_display('invoice_no'); ?> # <?= $invoice_all_data[0]['outlet_id'] . $invoice_all_data[0]['customer_id'] . $invoice_no ?></nobr>
                            ...
                            <div style="margin: 0; padding:0">
                                ...
                                <div class="text-center" align="" style="font-size: 11px; margin-top: 0cm !important">
                                    <div style="margin:0 px"><b>Note: </b><br>
                                        <div style="text-align:center; margin-top: 0.1cm; font-size: 11px">
                                            <td><strong># Please check the Products before going<br>Beyond the Authority of the concern. No<br>
                                                    exchange or refund is admissible after<br>sale</strong></td>
                ...
                <div class="panel-footer text-left">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url('Cinvoice/gui_pos'); ?>"><?php echo display('cancel') ?></a>
