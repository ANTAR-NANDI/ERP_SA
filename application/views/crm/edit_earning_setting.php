                    ...
                    <div class="panel-body">
                        ...
                        <input class="form-control" value="<?php echo $edit_data[0]['id'] ?>" name="setting_id" id="setting_id" type="hidden" required="" tabindex="1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" name="point" value="<?php echo $edit_data[0]['points'] ?>" id="point" type="text" placeholder="<?php echo "Enter Points" ?>" required="" tabindex="1">
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                            <button class="btn btn-success" onclick="Crm_Setting_Update()">Update</button>
                    ...
                    <div class="panel-body">
                        ...
                        <div>
                            ...
                            <div class="table-responsive" id="printableArea">
                                <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="fetch_edit_product">
                                    <thead>
                                        <tr>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    var table = $("#fetch_edit_product").DataTable({
      ...
      serverMethod: "post",
      ajax: {
        url: base_url + "crm/CheckProductList_Setting_wise",
        data: function (d) {
    ...
    function Crm_Setting_Update(e)
    {
        ...
        {
            $.ajax({
                url: '<?= base_url() ?>' + 'crm/updateEarningSetting',
                dataType: "json",
                type: 'POST',
                data:  {
