                    ...
                    <div class="panel-body">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="customer_name" class="col-sm-4 col-form-label">Customer ID:<i class="text-danger">*</i></label>
                                <div class="col-sm-8">
                                    <input class="form-control" name="customer_id_two" id="customer_id_two" type="text" placeholder="Customer ID" value="{customer_id_two}" required="" tabindex="1">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" name="customer_name_bn" id="customer_name_bn" type="text" placeholder="<?php echo display('customer_name') ?>" required="" value="{customer_name_bn}" tabindex="1">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <option value="">Select One</option>
                                        <?php foreach ($card_list as $card) { 
                                            if($membership_id == $card['id']){
                                            ?>
                                            <option selected value="<?php echo html_escape($card['id']) ?>"><?php echo $card['name'] ?></option>
                                            <?php } else{ ?>
                            ...
                            <div class="form-group row">
                                <label for="card_number" class="col-sm-4 col-form-label"><?php echo "Card Number" ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-8">
                                    <input class="form-control" name="card_number" value="<?php echo $card_number ?>" id="card_number" type="text" placeholder="<?php echo "Card Number" ?>" tabindex="1">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="customer_name" class="col-sm-4 col-form-label">Card No:</label>
                                <div class="col-sm-8">
                                    <input class="form-control" name="friend_card" id="friend_card" type="text" placeholder="Card No." value="{friend_card}" tabindex="1">
                                </div>
                            </div>
                            <?php if(!($outlet_user)){ ?>
                            <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="outlet_id" class="form-control" required="" tabindex="3">
                                             <?php foreach ($cw_list as $cw) { 
                                                if($cw['warehouse_id'] == $outlet_id){
                                                ?>
                                                <option selected value="<?php echo html_escape($cw['warehouse_id']) ?>"><?php echo $cw['central_warehouse'] ?></option>
                                                <?php } else{ ?>
                                                <option value="<?php echo html_escape($cw['warehouse_id']) ?>"><?php echo $cw['central_warehouse'] ?></option>
                                             <?php }} ?>
                                             <?php foreach ($outlet_list_to as $outlet) { 
                                                if($outlet['outlet_id'] == $outlet_id){
                                                ?>
                                                <option selected value="<?php echo html_escape($outlet['outlet_id']) ?>"><?php echo $outlet['outlet_name'] ?></option>
                                                <?php } else{ ?>
                                                <option value="<?php echo html_escape($outlet['outlet_id']) ?>"><?php echo $outlet['outlet_name'] ?></option>
                                             <?php }} ?>
                                        </select>
