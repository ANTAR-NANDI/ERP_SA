	                    ...
	                    <div class="panel-body">
	                        <div class="row">
	                            ...
	                            <div class="col-sm-8 purchasedetails-address">
	                                 <img  src="<?php if (isset($Web_settings[0]['invoice_logo'])) {echo $Web_settings[0]['invoice_logo']; }?>" style="width: 120px" alt="">
	                                <br>
	                        ...
	                        <div class="table-responsive m-b-20">
	                            <table class="table table-striped table-bordered">
	                                ...
	                                <tfoot>
										...
										<td align="center" ><b><?php echo (($position==0)?"$currency {subTotal}":"{subTotal} $currency") ?></b></td>
										<td align="center" ><b><?php echo (($position==0)?"$currency {subTotal_discount}":"{subTotal_discount} $currency") ?></b></td>
