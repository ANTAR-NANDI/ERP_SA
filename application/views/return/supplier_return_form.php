                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-sm-8">
                                         ...
                                         <input type="hidden" class="customer_hidden_value" name="supplier_id" value="{supplier_id}" id="SchoolHiddenId" />
                                          <input type="hidden" class="" name="due_amount" value="<?php echo $purchase_all_data[0]['due_amount'] ?>" />
                                     </div>
                                 </div>
                             </div>
                         </div>
                             ...
                             <table class="table table-bordered table-hover" id="purchase">
                                 <thead>
                                     <tr>
                                         ...
                                         <th class="text-center"><?php echo "discount" ?> <i class="text-danger"></i></th>
                                 ...
                                 <tbody id="addinvoiceItem">
                                     {purchase_all_data}
                                     <tr>
                                         <td style="width:214px" class="product_field">
                                         ...
                                         <td>
                                             <input type="text" name="price_discount[]" onkeyup="quantity_calculateSreturn({sl});" onchange="quantity_calculateSreturn({sl});" value="{discount}" id="price_discount_{sl}" class="price_discount{sl} form-control text-right" min="0" tabindex="5" required="" placeholder="0.00" readonly="" />
                                         </td>
                                         <!-- Discount -->
                                         <td>
                                         ...
                                         <td>
                                             ...
                                             <!-- Discount calculate end -->
                                              <!-- Discount calculate start-->
                                              <input type="hidden" class="itemwise_discount" name="itemwise_discount[]" id="itemwise_discount_{sl}" value="" />

                                            <!-- <input type="text" id="total_itemwise_discount" class="total_itemwise_discount" name="total_itemwise_discount" value="" /> -->
                                            <!-- Discount calculate end -->
                                 ...
                                 <tfoot>
                                     ...
                                     <tr>
                                         ...
                                         <input type="hidden" name="total_itemwise_discount" id="total_itemwise_discount" value="" />
